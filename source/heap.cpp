...
int MaxHeap::Maximum() { return A[0]; }
...
int MinHeap::Minimum() { return A[0]; }
...
int MinHeap::Parent(int i) { return i / 2; }
//	returns index of left child
int MinHeap::Left(int i) { return 2 * i; }
//	returns index of right child
int MinHeap::Right(int i) { return 2 * i + 1; }
void MinHeap::Print() {
  for (int i = 0; i < heaplength; i++) {
    cout << A[i] << " ";
  }
